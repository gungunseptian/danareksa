<?php namespace App\Http\Controllers;
	...
	class AdminPagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ['label'=>'Subtitle','name'=>'subtitle','type'=>'text','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Description','name'=>'description','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','validation'=>'image|max:3000','width'=>'col-sm-10','datatable'=>'cms_users,name'];
			//$this->form[] = ['label'=>'Cms Users','name'=>'id_cms_users','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','dataenum'=>'Active;InActive'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'checkbox','validation'=>'required','width'=>'col-sm-10'];
			# OLD END FORM
	    ...
	    */
	    public function hook_after_edit($id) {
			...
			$this->return_url = "/admin/pages/edit/".$id;
	    }
